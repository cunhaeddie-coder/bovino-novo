 ...
 * Anúncio ganha — exige Kyc.status=aprovado da Fazenda vendedora (INV-046).
 */
class AnuncioService
{
    ...
    // INV-046 — nunca satisfeito por temRelacaoComFazenda; a Fazenda
    // vendedora precisa ter Kyc aprovado antes de publicar.
